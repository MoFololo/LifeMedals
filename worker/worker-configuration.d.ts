/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d6031121907d69114ff82f355d8c8618)
// Runtime types generated with workerd@1.20260825.1 2026-07-30 
interface __BaseEnv_Env {
	MONSTER_ASSETS: R2Bucket;
	MONSTER_DB: D1Database;
	MONSTER_GENERATION_QUEUE: Queue;
	OPENAI_MODEL: "gpt-5.6-terra";
	MONSTER_IMAGE_MODEL: "gpt-image-2";
	MONSTER_STYLE_VERSION: "grotesque-pixel-v3-transparent";
	MONSTER_PROMPT_VERSION: "monster-image-v5";
	MONSTER_CONCEPT_PROMPT_VERSION: "monster-concept-v3";
	MONSTER_ASSET_BASE_URL: "https://lifemedals-api-staging.david-lian0809.workers.dev/monster-assets" | "https://lifemedals-api.david-lian0809.workers.dev/monster-assets";
	GLOBAL_REQUESTS_PER_MINUTE: "20";
	MONTHLY_REQUEST_BUDGET: "500";
	MONSTER_IMAGES_PER_MINUTE: "2";
	MONTHLY_MONSTER_IMAGE_BUDGET: "100";
	OPENAI_API_KEY: string;
	GLOBAL_USAGE_GATE: DurableObjectNamespace<import("./src/index").GlobalUsageGate>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "GlobalUsageGate";
	}
